...
![Список конфигураций дискаверинга с нумерацией зон](../images/discovery-configs-list-annotated.png)
...
конфигурации дискаверинга. При достижении лимита создание новой отклоняется с понятным
сообщением.
