...
| Проверка расписания дискaверинга | Как часто система проверяет, не пора ли запустить какую-то конфигурацию дискaверинга по её расписанию — это не то же самое, что периодичность самого сканирования. |
...
устройств, тревоги, профили, конфигурации дискaверинга, логи, задачи (очереди), окна
